...
```text
                 CCCCC  EEEEE  X   X  Y   Y  RRRR    OOO   U   U  TTTTT  EEEEE  RRRR
                 C      E       X X    Y   Y  R   R  O   O  U   U    T    E      R   R
                 C      EEEE     X      Y Y   RRRR   O   O  U   U    T    EEEE   RRRR
                 C      E       X X      Y    R R    O   O  U   U    T    E      R R
                 CCCCC  EEEEE  X   X     Y    R  RR   OOO    UUU     T    EEEEE  R  RR
```
